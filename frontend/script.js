...
document.addEventListener("DOMContentLoaded", () => {
    const shareFoodBtn = document.querySelector(".btn.btn-primary");
    const shareFoodModal = document.getElementById("shareFoodModal");
    const closeModal = document.querySelector(".close-modal");

    // Show the modal when the "Share Food" button is clicked
    shareFoodBtn.addEventListener("click", () => {
        shareFoodModal.style.display = "block";
    });
